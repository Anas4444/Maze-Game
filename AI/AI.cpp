...
AI::AI(const Coordinate<int>& pos) {
    AI::bots.push_back(this);
    this->position = pos;
    this->destination = Coordinate<int>(8, 3);
}

AI::AI(const Coordinate<int>& pos, const Coordinate<int>& dest) {
    AI::bots.push_back(this);
    this->destination = dest;
    this->position = pos;
}

AI::AI(const Coordinate<int>& pos, const Coordinate<int>& dest, int nType) {
    AI::bots.push_back(this);
    this->destination = dest;
    this->position = pos;
...
AI::AI(const Coordinate<int>& pos, const Coordinate<int>& dest, int nType, int weight) {
    AI::bots.push_back(this);
    this->destination = dest;
    this->position = pos;
    this->neighbourType = nType;
...
void AI::setPosition(const Coordinate<int>& pos)
{
    this->position = pos;
}

void AI::setDestination(const Coordinate<int>& dest)
{
    this->destination = dest;
}

void AI::setWeight(int weight)
{
    this->weight = weight;
}
...
std::vector<std::string> AI::fillText(const std::string& path) {
    std::string text;
...
int AI::roadType(const Coordinate<int>& road)
{
...
void AI::drawPath(const int& alpha=1) {
...
bool AI::inExplored(const Coordinate<int>& pair) {
...
bool AI::isExplored(const Coordinate<int>& data, Node<Coordinate<int>>* parent) {
    for (int i=0; i<this->explored.size(); i++) {
...
Coordinate<int> AI::bestPosition8(const Coordinate<int>& loc) {
...
Coordinate<int> AI::bestPosition4(const Coordinate<int>& loc) {
...
std::vector<Coordinate<int>> AI::neighbours8(const Coordinate<int>& loc) {
    Coordinate<int> nghb[8] {Coordinate<int>(loc.x+1, loc.y), Coordinate<int>(loc.x-1, loc.y),
                             Coordinate<int>(loc.x, loc.y+1), Coordinate<int>(loc.x, loc.y-1),
                             Coordinate<int>(loc.x+1, loc.y+1), Coordinate<int>(loc.x+1, loc.y-1),
                             Coordinate<int>(loc.x-1, loc.y+1), Coordinate<int>(loc.x-1, loc.y-1)}; 
...
std::vector<Coordinate<int>> AI::neighbours4(const Coordinate<int>& loc) {
    Coordinate<int> nghb[4] {Coordinate<int>(loc.x+1, loc.y), Coordinate<int>(loc.x-1, loc.y),
                             Coordinate<int>(loc.x, loc.y+1), Coordinate<int>(loc.x, loc.y-1)}; 
    std::vector<Coordinate<int>> result;
    for (int i=0; i<4; i++) {
